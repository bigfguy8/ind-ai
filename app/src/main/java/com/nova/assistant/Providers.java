...
public final class Providers {
    ...
    static {
        // ==== Reliable free providers (require signup) ====
        ALL.add(new Provider("Groq  ★ recommended",
        ...
        // ==== No-key providers (unreliable — testing only) ====
        ALL.add(new Provider("Pollinations (no key, unreliable)",
                "https://text.pollinations.ai/v1/chat/completions",
                "openai-fast", "no key", true, false));
        ALL.add(new Provider("KeylessAI (no key, unreliable)",
                "https://keylessai.thryx.workers.dev/v1/chat/completions",
                "llama-3.1-8b-instant", "no key", false, false));
        ALL.add(new Provider("Cerebras",
                "https://api.cerebras.ai/v1/chat/completions",
                "llama3.1-8b", "csk-...", false, true));
        ALL.add(new Provider("Google Gemini",
